  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col items-center lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3 mb-2 py-1.5 rounded-full border border-black/5 dark:border-white/5 bg-white dark:bg-black text-xs font-grotesk font-medium  tracking-widest uppercase text-brand">
            This week
          </span>
